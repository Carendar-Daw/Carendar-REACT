...
const workboxCore = require('workbox-core') ;
const  workboxExpiration = require('workbox-expiration');
const workboxPrecaching = require('workbox-precaching');
...
const { registerRoute } = workboxRouting;
const { StaleWhileRevalidate } = workboxStrategies;
